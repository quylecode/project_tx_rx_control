...
static void LVQ_SPIx_Init(SPI_TypeDef* SPIx, LVQ_SPI_PinsPack_t pinspack, LVQ_SPI_Mode_t SPI_Mode, uint16_t SPI_BaudRatePrescaler, uint16_t SPI_MasterSlave, uint16_t SPI_FirstBit) {
    ...
    if (SPIx == SPI1) {
        ...
        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI1_DATASIZE;
    }
#endif
#ifdef USE_SPI2
    if (SPIx == SPI2) {
        ...
        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI2_DATASIZE;
    }
#endif
#ifdef USE_SPI3
    if (SPIx == SPI3) {
        ...
        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI3_DATASIZE;
    ...
    if (SPIx == SPI4) {
        /* Enable SPI clock */
				RCC_APB2PeriphClockCmd(RCC_APB2ENR_SPI4EN, ENABLE);

        /* Init pins */
        LVQ_SPI4_INT_InitPins(pinspack);

        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI4_DATASIZE;
    }
#endif
#ifdef USE_SPI5
    if (SPIx == SPI5) {
        ...
        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI5_DATASIZE;
    }
#endif
#ifdef USE_SPI6
    if (SPIx == SPI6) {
        /* Enable SPI clock */
        RCC_APB2PeriphClockCmd(RCC_APB2ENR_SPI6EN, ENABLE);

        /* Init pins */
        LVQ_SPI6_INT_InitPins(pinspack);

        /* Set options */
        SPI_InitStruct.SPI_DataSize = LVQ_SPI6_DATASIZE;
    }
#endif
...
void LVQ_SPI1_INT_InitPins(LVQ_SPI_PinsPack_t pinspack) {
    ...
    if (pinspack == LVQ_SPI_PinsPack_1) {
        LVQ_GPIO_Init(GPIOA, GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7, LVQ_GPIO_Mode_AF, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_Fast);
    }
#endif
#if defined(GPIOB)
    if (pinspack == LVQ_SPI_PinsPack_2) {
        ...
        LVQ_GPIO_Init(GPIOB, GPIO_PIN_3 | GPIO_PIN_5, LVQ_GPIO_Mode_AF, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_Fast);
				LVQ_GPIO_Init(GPIOB, GPIO_PIN_4, LVQ_GPIO_Mode_IN, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_UP, LVQ_GPIO_Speed_Fast);
		}
#endif
...
void LVQ_SPI2_INT_InitPins(LVQ_SPI_PinsPack_t pinspack) {
    ...
    if (pinspack == LVQ_SPI_PinsPack_1) {
        LVQ_GPIO_Init(GPIOB, GPIO_PIN_10, LVQ_GPIO_Mode_AF, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_Fast);
        LVQ_GPIO_Init(GPIOC, GPIO_PIN_2 | GPIO_PIN_3, LVQ_GPIO_Mode_AF, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_Fast);
    }
#endif
#if defined(GPIOB)
    if (pinspack == LVQ_SPI_PinsPack_2) {
        LVQ_GPIO_Init(GPIOB, GPIO_PIN_13 | GPIO_PIN_14 | GPIO_PIN_15, LVQ_GPIO_Mode_AF, LVQ_GPIO_OType_PP, LVQ_GPIO_PuPd_NOPULL, LVQ_GPIO_Speed_Fast);
    }
#endif
#if defined(GPIOI)
