...
{
    /* Clear all flags */
    LVQ_DMA_ClearFlag(DMA_Stream, DMA_FLAG_ALL);
}

void LVQ_DMA_ClearFlag(DMA_Stream_TypeDef* DMA_Stream, uint32_t flag) 
{
    uint32_t location;
    ...
    if (DMA_Stream < DMA2_Stream0) 
		...
		/* DMA_LIFCR Address offset: 0x008 */
		/* DMA_HIFCR Address offset: 0x00C */
...
__weak void LVQ_DMA_TransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
            the LVQ_DMA_TransferCompleteHandler could be implemented in the user file
    */
}

__weak void LVQ_DMA_HalfTransferCompleteHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
            the LVQ_DMA_HalfTransferCompleteHandler could be implemented in the user file
    */
}

__weak void LVQ_DMA_TransferErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
            the LVQ_DMA_TransferErrorHandler could be implemented in the user file
    */
}

__weak void LVQ_DMA_DirectModeErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
            the LVQ_DMA_DirectModeErrorHandler could be implemented in the user file
    */
}

__weak void LVQ_DMA_FIFOErrorHandler(DMA_Stream_TypeDef* DMA_Stream) {
    /* NOTE: This function should not be modified, when the callback is needed,
            the LVQ_DMA_FIFOErrorHandler could be implemented in the user file
    */
}
...
/*****************************************************************/
static void LVQ_DMA_INT_ProcessInterrupt(DMA_Stream_TypeDef* DMA_Stream) 
{
    /* Get DMA interrupt status flags */
    uint16_t flags = LVQ_DMA_GetFlags(DMA_Stream, DMA_FLAG_ALL);
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream0);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream1);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream2);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream3);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream4);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream5);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream6);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA1_Stream7);
}
#endif
...
DMA2_Stream0_IRQHandler(void) {
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream0);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream1);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream2);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream3);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream4);
}
#endif
...
DMA2_Stream5_IRQHandler(void) {
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream5);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream6);
}
#endif
...
{
    /* Call user function */
    LVQ_DMA_INT_ProcessInterrupt(DMA2_Stream7);
}
#endif
