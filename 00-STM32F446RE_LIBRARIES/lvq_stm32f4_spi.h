...
/**
 * @brief  SPI Prescaler enumeration to select pins combination for SPI
 */
typedef enum {
		LVQ_SPI_BaudRatePrescaler_2   =      ((uint16_t)0x0000),
		LVQ_SPI_BaudRatePrescaler_4   =      ((uint16_t)0x0008),
		LVQ_SPI_BaudRatePrescaler_8   =      ((uint16_t)0x0010),
		LVQ_SPI_BaudRatePrescaler_16  =      ((uint16_t)0x0018),
		LVQ_SPI_BaudRatePrescaler_32  =      ((uint16_t)0x0020),
		LVQ_SPI_BaudRatePrescaler_64  =      ((uint16_t)0x0028),
		LVQ_SPI_BaudRatePrescaler_128 =      ((uint16_t)0x0030),
		LVQ_SPI_BaudRatePrescaler_256 =      ((uint16_t)0x0038)
} LVQ_SPI_BaudRatePrescaler_t;
...
#define LVQ_SPI1_PRESCALER   SPI_BaudRatePrescaler_32
#endif
//Specify datasize
