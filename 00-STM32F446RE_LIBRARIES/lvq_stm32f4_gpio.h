 ...
 */
typedef enum {
    LVQ_GPIO_Mode_IN  = 0x00,  /*!< GPIO Pin as General Purpose Input */
    LVQ_GPIO_Mode_OUT = 0x01,  /*!< GPIO Pin as General Purpose Output */
    LVQ_GPIO_Mode_AF  = 0x02,  /*!< GPIO Pin as Alternate Function */
    LVQ_GPIO_Mode_AN  = 0x03,  /*!< GPIO Pin as Analog */
} LVQ_GPIO_Mode_t;
 ...
 */
typedef enum {
    LVQ_GPIO_OType_PP = 0x00, /*!< GPIO Output Type Push-Pull */
    LVQ_GPIO_OType_OD = 0x01  /*!< GPIO Output Type Open-Drain */
} LVQ_GPIO_OType_t;
 ...
 */
typedef enum {
    LVQ_GPIO_Speed_Low    = 0x00,   /*!< GPIO Speed Low */
    LVQ_GPIO_Speed_Medium = 0x01,   /*!< GPIO Speed Medium */
    LVQ_GPIO_Speed_Fast   = 0x02,   /*!< GPIO Speed Fast */
    LVQ_GPIO_Speed_High   = 0x03    /*!< GPIO Speed High */
} LVQ_GPIO_Speed_t;
 ...
 */
typedef enum {
    LVQ_GPIO_PuPd_NOPULL = 0x00,     /*!< No pull resistor */
    LVQ_GPIO_PuPd_UP     = 0x01,     /*!< Pull up resistor enabled */
    LVQ_GPIO_PuPd_DOWN   = 0x02      /*!< Pull down resistor enabled */
} LVQ_GPIO_PuPd_t;
 ...
 * @param  GPIO_Mode: Select GPIO mode. This parameter can be a value of @ref LVQ_GPIO_Mode_t enumeration
 * @param  GPIO_OType: Select GPIO Output type. This parameter can be a value of @ref LVQ_GPIO_OType_t enumeration
 * @param  GPIO_PuPd: Select GPIO pull resistor. This parameter can be a value of @ref LVQ_GPIO_PuPd_t enumeration
 * @param  GPIO_Speed: Select GPIO speed. This parameter can be a value of @ref LVQ_GPIO_Speed_t enumeration
 * @retval None
 */
...
void LVQ_GPIO_SetPinAsInput(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);

/**
 * @brief  Sets pin(s) as output
 * @note   Pins HAVE to be initialized first using @ref LVQ_GPIO_Init() or @ref LVQ_GPIO_InitAlternate() function
 ...
 * @retval None
 */
void LVQ_GPIO_SetPinAsOutput(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
 ...
 * @retval None
 */
void LVQ_GPIO_SetPinAsAnalog(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);

/**
 * @brief  Sets pin(s) as alternate function
 * @note   For proper alternate function, you should first init pin using @ref LVQ_GPIO_InitAlternate() function.
 ...
 * @retval None
 */
void LVQ_GPIO_SetPinAsAlternate(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
 ...
 * @param  GPIO_Pin: Select GPIO pin(s). You can select more pins with | (OR) operator to set them as output
 * @param  GPIO_PuPd: Pull resistor option. This parameter can be a value of @ref LVQ_GPIO_PuPd_t enumeration
 * @retval None
 */
 ...
 * @retval None
 */
#define LVQ_GPIO_SetPinLow(GPIOx, GPIO_Pin)          ((GPIOx)->BSRR |= (GPIO_Pin) << 16)
 ...
 * @retval None
 */
#define LVQ_GPIO_SetPinHigh(GPIOx, GPIO_Pin)         ((GPIOx)->BSRR |= (GPIO_Pin))
 ...
 * @retval None
 */
#define LVQ_GPIO_SetPinValue(GPIOx, GPIO_Pin, val)   ((val) ? LVQ_GPIO_SetPinHigh(GPIOx, GPIO_Pin) : LVQ_GPIO_SetPinLow(GPIOx, GPIO_Pin))
 ...
 * @retval None
 */
#define LVQ_GPIO_TogglePinValue(GPIOx, GPIO_Pin)     ((GPIOx)->ODR ^= (GPIO_Pin))
 ...
 * @retval None
 */
#define LVQ_GPIO_SetPortValue(GPIOx, value)          ((GPIOx)->ODR = (value))
 ...
 */
#define LVQ_GPIO_GetInputPinValue(GPIOx, GPIO_Pin)   (((GPIOx)->IDR & (GPIO_Pin)) == 0 ? 0 : 1)
 ...
 * @retval 1 in case pin is high, or 0 if low
 */
#define LVQ_GPIO_GetOutputPinValue(GPIOx, GPIO_Pin)  (((GPIOx)->ODR & (GPIO_Pin)) == 0 ? 0 : 1)
 ...
 */
#define LVQ_GPIO_GetPortInputValue(GPIOx)            ((GPIOx)->IDR)
 ...
 */
#define LVQ_GPIO_GetPortOutputValue(GPIOx)           ((GPIOx)->ODR)
